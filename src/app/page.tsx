...
function Navbar({ activeSection }: { activeSection: string }) {
  return (
    <header className="fixed left-1/2 top-6 z-50 -translate-x-1/2 w-[calc(100%-24px)] md:w-auto max-w-3xl md:max-w-fit">
      <nav className="flex items-center rounded-full border border-slate-200 bg-white/80 px-3 py-2 shadow-md backdrop-blur w-full md:w-auto">
        ...
        <div className="flex items-center gap-1 w-full md:w-auto overflow-x-auto md:overflow-visible whitespace-nowrap [-webkit-overflow-scrolling:touch]">
          {[
            ["home", "Home"],
            ["about", "About"],
            ["projects", "Projects"],
      ...
      {activeSection !== "contact" && (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
          <div className="flex gap-3">
            ...
            <CircleIconButton
              label="Email"
              href="mailto:aqilaiman058@gmail.com"
            ...
            <CircleIconButton
              label="LinkedIn"
              href="https://www.linkedin.com/in/aqilaiman260/"
